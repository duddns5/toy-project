...
public class JDBCTemplate {
	...
	// Singleton 패턴
	// 해당 클래스의 인스턴스가 하나만 생성되어야 할 떄 사용하는 디자인패턴
	...
	private JDBCTemplate() {
		...
		try {
			...
			final String DB_URL = "jdbc:oracle:thin:@myhost:1521/orclservicename";
			...
			final String CONN_FACTORY_CLASS_NAME = "oracle.jdbc.thin.@pclassmdb_high?TNS_ADMINC:\\CODE\\Wallet_PCLASSMDB";
	...
	public Connection getConnection() {
		...
		try {
			...
			// 트랜잭션 관리를 개발자가 하기 위해 Auto Commit 설정 끄기
